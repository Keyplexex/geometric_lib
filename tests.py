...
class TestGeometricLib(unittest.TestCase):
    ...
    def test_circle(self):
        ...
        self.assertAlmostEqual(circle.area(0), "Error")
        self.assertAlmostEqual(circle.perimeter(-5), "Error")
    ...
    def test_rectangle(self):
        ...
        self.assertEqual(rectangle.perimeter(-4, 6), "Error")
        self.assertEqual(rectangle.area(2, 5), 10)
        self.assertEqual(rectangle.area(3, 7), 21)
        self.assertEqual(rectangle.area(4, 0), "Error")
    ...
    def test_square(self):
        ...
        self.assertEqual(square.area(-109), "Error")
    ...
    def test_triangle(self):
        ...
        self.assertEqual(triangle.area(-4, 3), "Error")
        self.assertEqual(triangle.perimeter(4, 5, 6), 15)
        self.assertEqual(triangle.perimeter(4, -5, 6), "Error")
    ...
    def test_trapezoid(self):
        ...
        self.assertEqual(trapezoid.area(-5, 7, -4), "Error")
        self.assertEqual(trapezoid.perimeter(5, 7, 6, 8), 26)
        self.assertEqual(trapezoid.perimeter(5, 7, 6, -8), "Error")
    ...
    def test_rhombus(self):
        ...
        self.assertEqual(rhombus.area(10, -6), "Error")
        self.assertEqual(rhombus.perimeter(5), 20)
        self.assertEqual(rhombus.perimeter(0), "Error")
    ...
    def test_parallelogram(self):
        ...
        self.assertEqual(parallelogram.area(8, -4), "Error")
        self.assertEqual(parallelogram.perimeter(5, 6), 22)
        self.assertEqual(parallelogram.perimeter(0, 6), "Error")
    ...
    def test_ellipse(self):
        ...
        self.assertAlmostEqual(ellipse.area(5, -3), "Error")
        self.assertAlmostEqual(ellipse.perimeter(5, 3), 25.526986393758545)
        self.assertAlmostEqual(ellipse.perimeter(5, 0), "Error")
